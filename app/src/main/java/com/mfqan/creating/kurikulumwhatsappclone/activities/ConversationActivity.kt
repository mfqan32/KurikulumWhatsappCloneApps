...
import com.mfqan.creating.kurikulumwhatsappclone.adapter.ConversationAdapter
...
import com.mfqan.creating.kurikulumwhatsappclone.util.DATA_CHAT_MESSAGE
import com.mfqan.creating.kurikulumwhatsappclone.util.DATA_CHAT_MESSAGE_TIME
...
class ConversationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (chatId.isNullOrEmpty() || userId.isNullOrEmpty()) {
            Toast.makeText(this, "WA Error", Toast.LENGTH_SHORT).show()
            finish()
        }
